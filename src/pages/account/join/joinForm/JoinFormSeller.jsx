...
export default function JoinFormSeller() {
    ...
    const handleBusinessChange = ((e) =>{
        e.target.id === "joinCompany" && setCompanyVal(e.target.value);
        e.target.id === "joinStore" && setStoreVal(e.target.value);
    });
  ...
  return (
    <>
      <Form>
        ...
        <JoinCompany 
            value={{companyVal, storeVal}}
            handleOnChange={handleBusinessChange}
        />
        <Button
          className="large"
          onClick={handleJoin}
